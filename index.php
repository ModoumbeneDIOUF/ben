  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:benmetalwork216@gmail.com">benmetalwork216@gmail.com</a>
        <i class="bi bi-phone-fill phone-icon"></i> +221 77 961 79 72
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        ...
        <a href="index.html"><img src="assets/img/logo.jpg" alt="logo" class="img-fluid" style="width: 120px; height: 350px;"></a>
      </div>
          ...
          <div class="carousel-item active" style="background-image: url('assets/img/slide/slide-4.jpeg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp">Préfabrication de pièces sur site <br/><br/> Ces types de constructions impliquent des systèmes de tuyauteries importants, qui relient divers systèmes et équipements</p>
          ...
          <div class="carousel-item" style="background-image: url('assets/img/slide/slide-5.jpeg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animate__animated animate__fadeInUp">En raison des délais serrés et des espaces limités sur place, les projets de construction industrielle reposent en grande partie sur la préfabrication de tuyauteries</p>
                <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 video-box">
            <img src="assets/img/slide-6.jpeg" class="img-fluid" alt="">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-10 footer-info">
            <h3>BEN METAL WORK</h3>
            <p>
              Mboro Thiés Sénégal <br>
              <strong>Téléphone:</strong> +221 77 961 79 72<br>
              <strong>Email:</strong> benmetalwork216@gmail.com<br>
            </p>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/BEN METAL WORK-one-page-bootstrap-template-free/ -->
